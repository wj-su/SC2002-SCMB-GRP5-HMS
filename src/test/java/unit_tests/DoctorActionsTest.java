...
public class DoctorActionsTest {
    ...
    public void testAcceptOrDeclineAppointmentRequests() {
        ...
        Appointment appointment = new Appointment(103, patient.getId(), doctor.getName(), "16-Nov-2024", "09:00", "Pending");
        Appointment.getAllAppointments().add(appointment);
        Appointment appointment2 = new Appointment(104, patient.getId(), doctor.getName(), "16-Nov-2024", "09:00", "Pending");
        Appointment.getAllAppointments().add(appointment2);
